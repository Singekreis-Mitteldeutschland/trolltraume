...
\geometry{left=1.3cm,right=1.3cm,top=1.9cm,bottom=1.3cm} 
...
\begin{figure}[H]
\includepdf[trim=00mm 0mm 00mm 00mm ,pagecommand={},pages=1,width=1.1\textwidth]{Rohdaten/Noten/\Liedname _Noten.pdf}
\end{figure}
\vspace{\Abstand}
